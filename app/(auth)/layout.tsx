  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        <div className="w-full h-full flex items-center justify-center scale-[0.75] sm:scale-[0.75] md:scale-[0.80] lg:scale-[0.85] lg:pt-16 min-[1281px]:scale-100  min-[1281px]:pt-14 transition-transform duration-300 ease-in-out">
          {children}
        </div>
      </div>
    </main>
