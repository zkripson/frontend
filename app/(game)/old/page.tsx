...
import { SetupPanel } from "../[sessionId]/components/SetupPanel";
...
import { GeneralMessageKey } from "../[sessionId]/components/general";
...
export default function GameSession() {
  ...
  const onReady = useCallback(() => {
    ...
    if (evmWallet?.address) {
      submitBoardCommitment({} as BoardCommitment, {
        onSuccess: () => {
