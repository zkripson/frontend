...
describe.skip("usePlayerActions", () => {
  ...
  const setCreateProfileLoadingSpy = jest.spyOn(
    playerActions,
    "setCreateProfileLoading"
  );
  const setGetProfileLoadingSpy = jest.spyOn(
    playerActions,
    "setGetProfileLoading"
  );
  const setUpdateProfileLoadingSpy = jest.spyOn(
    playerActions,
    "setUpdateProfileLoading"
  );
  const setGetOngoingSessionsLoadingSpy = jest.spyOn(
    playerActions,
    "setGetOngoingSessionsLoading"
  );
  const setGetPlayerRewardsLoadingSpy = jest.spyOn(
    playerActions,
    "setGetPlayerRewardsLoading"
  );
  const setGetPlayerPointsLoadingSpy = jest.spyOn(
    playerActions,
    "setGetPlayerPointsLoading"
  );
  const setGetLeaderboardLoadingSpy = jest.spyOn(
    playerActions,
    "setGetLeaderboardLoading"
  );
  const setGetWeeklyLeaderboardLoadingSpy = jest.spyOn(
    playerActions,
    "setGetWeeklyLeaderboardLoading"
  );
  const setGetPointsDistributionLoadingSpy = jest.spyOn(
    playerActions,
    "setGetPointsDistributionLoading"
  );
  const setGetPointsStatsLoadingSpy = jest.spyOn(
    playerActions,
  ...
  const setWeeklyLeaderboardSpy = jest.spyOn(
    playerActions,
    "setWeeklyLeaderboard"
  );
  const setPointsDistributionSpy = jest.spyOn(
    playerActions,
  ...
  describe("createProfile", () => {
    it("should call the correct actions when createProfile succeeds", async () => {
      ...
      (playerApi.createProfile as jest.Mock).mockResolvedValueOnce(
        mockResponse
      );
      ...
      const createProfileData = {
        ...
        channel: "twitter" as "twitter" | "farcaster",
      };
  ...
  describe("getProfile", () => {
    it("should call the correct actions when getProfile succeeds", async () => {
      ...
      expect(playerApi.getProfile).toHaveBeenCalledWith(
  ...
  describe("getPlayerRewards", () => {
    it("should call the correct actions when getPlayerRewards succeeds", async () => {
      ...
      (playerApi.getPlayerRewards as jest.Mock).mockResolvedValueOnce(
        mockRewards
      );
      ...
      // Call the function
      await result.current.getPlayerRewards();

      // Assertions
      expect(setGetPlayerRewardsLoadingSpy).toHaveBeenCalledWith(true);
      expect(playerApi.getPlayerRewards).toHaveBeenCalledWith(
        "0x1234567890abcdef1234567890abcdef12345678"
      );
