...
// Mock Redux actions
jest.mock("../index", () => ({
  setLoadingInviteCreation: jest.fn((payload) => ({
    type: "invite/setLoadingInviteCreation",
    payload,
  })),
  setInviteCreation: jest.fn((payload) => ({
    type: "invite/setInviteCreation",
    payload,
  })),
  setLoadingInviteAcceptance: jest.fn((payload) => ({
    type: "invite/setLoadingInviteAcceptance",
    payload,
  })),
  setInviteAcceptance: jest.fn((payload) => ({
    type: "invite/setInviteAcceptance",
    payload,
  })),
}));
...
describe("useInviteActions", () => {
  ...
  beforeEach(() => {
    ...
    (inviteAPI.createInvite as jest.Mock).mockResolvedValue(
      mockInviteCreationResponse
    );
    (inviteAPI.acceptInvite as jest.Mock).mockResolvedValue(
      mockInviteAcceptanceResponse
    );
  ...
  describe("createInvite", () => {
    it("should create an invite successfully", async () => {
      ...
      expect(setInviteCreation).toHaveBeenCalledWith(
        mockInviteCreationResponse
      );
  ...
  describe("acceptInvite", () => {
    ...
    it("should accept an invite successfully", async () => {
      ...
      expect(setInviteAcceptance).toHaveBeenCalledWith(
        mockInviteAcceptanceResponse
      );
      ...
      // Verify navigation
      expect(mockNavigate.push).toHaveBeenCalledWith(
        `/${mockInviteAcceptanceResponse.sessionId}`
      );
